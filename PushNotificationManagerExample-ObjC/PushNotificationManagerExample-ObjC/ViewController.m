...
-(void)initUI
{
    ...
    for (NSString * str in [titleArray subarrayWithRange:NSMakeRange(0, 2)]) {
        NSLog(@"%@",str);
    }
    
    for (NSString * str in [titleArray subarrayWithRange:NSMakeRange(2, 4)]) {
        NSLog(@"%@",str);
    }
    
    for (NSString * str in [titleArray subarrayWithRange:NSMakeRange(6, 2)]) {
        NSLog(@"%@",str);
    }
    
    for (NSString * str in [titleArray subarrayWithRange:NSMakeRange(8, 2)]) {
        NSLog(@"%@",str);
    }
    
    for (NSString * str in [titleArray subarrayWithRange:NSMakeRange(10, 2)]) {
        NSLog(@"%@",str);
    }
